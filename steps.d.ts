...
declare namespace CodeceptJS {
  export interface I {
    ...
    setupInbox() : void,
    typeMyEmailAddress() : void,
    typeMyEmailUserId() : void,
    fillFieldWithMyEmailAddress(selector: string, options: string) : void,
    fillFieldWithMyUserId(selector: string, options: string) : void,
    receiveEmail(subject: string) : void,
    clickVerificationLinkInEmail() : void,
    say(msg: string) : void,
